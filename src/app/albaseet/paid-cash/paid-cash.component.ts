...
@Component({
  selector: 'app-paid-cash',
  templateUrl: './paid-cash.component.html',
  styleUrls: ['./paid-cash.component.css']
})
export class PaidCashComponent {
...
price:any
  ...
  getinvioce() {
    this.servicess.GetAllInices().subscribe((list: any) => {
      ...
      this.invoice = this.storedata.filter((x:any)=>x.invoice_type==="001")
